...
cleanup_files() {
    ...
    find . -name "deploy-*.sh" -delete 2>/dev/null || true
    find . -name "fix_*.sh" -delete 2>/dev/null || true
    find . -name "apply_*.sh" -delete 2>/dev/null || true
    find . -name "verify_*.py" -delete 2>/dev/null || true
    ...
    rm -f .deployignore 2>/dev/null || true
    ...
    log_info "Removing specific development files..."
    rm -f api_test_config.json 2>/dev/null || true
    find . -name "api_test_report_*.json" -delete 2>/dev/null || true
    rm -f AUTH_LOGIN.json 2>/dev/null || true
    rm -f openapi.json 2>/dev/null || true
    rm -f todo.txt 2>/dev/null || true
    rm -f times.tsv 2>/dev/null || true
