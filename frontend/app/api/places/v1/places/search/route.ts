/**
 * Places API Proxy - Search Endpoint
 * 
 * Proxies requests to the backend Places API for full search
 */
...
export async function GET(request: NextRequest) {
  try {
    ...
    const backendUrl = new URL(`${BACKEND_URL}/places/v1/places/search`)
